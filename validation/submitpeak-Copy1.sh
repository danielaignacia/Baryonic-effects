...
#SBATCH -J offpeakstats2 ## job name
#SBATCH -o offpeakstats2.o%j ## output
#SBATCH -e offpeakstats2.e%j ## error file
...
srun python /global/u1/d/dgrandon/code_Peaks-offset-Copy2.py
