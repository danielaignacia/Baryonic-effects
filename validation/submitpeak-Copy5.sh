...
#SBATCH -J offpeakstats6 ## job name
#SBATCH -o offpeakstats6.o%j ## output
#SBATCH -e offpeakstats6.e%j ## error file
...
srun python /global/u1/d/dgrandon/code_Peaks-offset-Copy6.py
