...
#SBATCH -J offpeakstats3 ## job name
#SBATCH -o offpeakstats3.o%j ## output
#SBATCH -e offpeakstats3.e%j ## error file
...
srun python /global/u1/d/dgrandon/code_Peaks-offset-Copy3.py
