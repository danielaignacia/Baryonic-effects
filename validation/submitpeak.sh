...
#SBATCH -J offpeakstats1 ## job name
#SBATCH -o offpeakstats1.o%j ## output
#SBATCH -e offpeakstats1.e%j ## error file
...
srun python /global/u1/d/dgrandon/code_Peaks-offset-Copy1.py
